...
public class TweetService {
    ...
    private void handleTags(Tweet tweet) {
        ...
        Matcher matcher = pattern.matcher(tweet.getTagMessage());
        while (matcher.find()) {
    ...
    private void addTagLinks(List<Tweet> tweets) {
        ...
        for (Tweet tweet : tweets) {
            if (tweet.getTagMessage() != null){
                tweet.cleanTagMessage();
                String message = tweet.getTagMessage();
